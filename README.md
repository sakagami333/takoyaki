...
- 焼くときは、**油跳ね、オーバーフローなど大変危険** なので静かに入れること。これ、ゼッタイ。 心配ならいったん１L計量カップに移してから入れるようにするとよい。
- ペットボトルに入れておくと、生地が余った時にそのまま冷蔵庫に入れられる利点がある。地味にうれしい。500mlに小分けにしてもいいとおもいますが賞味期限注意。
...
- この方式だと、事前に生地を作っておき、持ち運ぶのが容易になります。
- 一番の難関が **４Lの空きボトルを用意する**ことなのです。 
...
・竹串 または たこ焼き用 ピック(串)
  →鉄板によっては傷がついたり、溶けてしまうので注意。竹串ならオールマイティで代用可能。おすすめ。
・油塗るやつ（キッチンペーパーでも代用可能。というかキッチンペーパーが楽)
・さい箸
・キッチンペーパー
```
#### 食べる
